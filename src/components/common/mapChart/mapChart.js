            ...
            <div onClick={onHandleClick} className="map-container">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 500" xmlSpace="preserve">
                    ...
                    <g id="text-abb" fill="#5286BC">
                        ...
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_16" transform="matrix(1 0 0 1 409 253)" fontSize="13" cursor="pointer">Covasna</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_17" transform="matrix(1 0 0 1 366 361)" fontSize="12" cursor="pointer">Dâmbovița</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_18" transform="matrix(1 0 0 1 245 438)" fontSize="15" cursor="pointer">Dolj</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_19" transform="matrix(1 0 0 1 546 269)" fontSize="13" cursor="pointer">Galați</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_20" transform="matrix(1 0 0 1 414 441)" fontSize="12" cursor="pointer">Giurgiu</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_21" transform="matrix(1 0 0 1 225 350)" fontSize="15" cursor="pointer">Gorj</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_22" transform="matrix(1 0 0 1 373 198)" fontSize="14" cursor="pointer">Harghita</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_23" transform="matrix(1 0 0 1 170 253)" fontSize="13" cursor="pointer">Hunedoara</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_24" transform="matrix(1 0 0 1 502 388)" fontSize="13" cursor="pointer">Ialomița</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_25" transform="matrix(1 0 0 1 519 117)" fontSize="14" cursor="pointer">Iași</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_26" transform="matrix(1 0 0 1 432 387)" fontSize="13" cursor="pointer">Ilfov</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_27" transform="matrix(1 0 0 1 257 68)" fontSize="13" cursor="pointer">Maramureș</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_28" transform="matrix(1 0 0 1 157 397)" fontSize="14" cursor="pointer">Mehedinți</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_29" transform="matrix(1 0 0 1 317 179)" fontSize="14" cursor="pointer">Mureș</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_30" transform="matrix(1 0 0 1 436 142)" fontSize="14" cursor="pointer">Neamț</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_31" transform="matrix(1 0 0 1 311 425)" fontSize="15" cursor="pointer">Olt</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_32" transform="matrix(1 0 0 1 414 341)" fontSize="13" cursor="pointer">Prahova</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_33" transform="matrix(1 0 0 1 167 70)" fontSize="13" cursor="pointer">Satu Mare</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_34" transform="matrix(1 0 0 1 208 123)" fontSize="14" cursor="pointer">Sălaj</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_35" transform="matrix(1 0 0 1 293 256)" fontSize="14" cursor="pointer">Sibiu</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_36" transform="matrix(1 0 0 1 391 79)" fontSize="14" cursor="pointer">Suceava</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_37" transform="matrix(1 0 0 1 342 455)" fontSize="12" cursor="pointer">Teleorman</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_38" transform="matrix(1 0 0 1 69 273)" fontSize="15" cursor="pointer">Timiș</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_39" transform="matrix(1 0 0 1 611 344)" fontSize="14" cursor="pointer">Tulcea</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_40" transform="matrix(1 0 0 1 548 192)" fontSize="14" cursor="pointer">Vaslui</text>
                        <text onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} id="iso_ro_41" transform="matrix(1 0 0 1 280 333)" fontSize="13" cursor="pointer">Vâlcea</text>
